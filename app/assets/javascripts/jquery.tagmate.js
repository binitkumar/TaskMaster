    ...
    $.fn.extend({
        ...
        tagmate: function(options) {
            ...
            return this.each(function() {
                        ...
                        if ((sel.start - pos) <= tag.length) {
                            (function(done) {
                                ...
                                if (options && options.length > 0) {
                                    ...
                                    menu.css("top", (textarea.position.top - 1) + "px");
                                    menu.show();
                ...
                $(textarea)
                    .unbind('.tagmate')
                    .on('focus.tagmate', function(e) {
                        tag_check();
                    })
                    .on('blur.tagmate', function(e) {
                        // blur on textarea fires before mouse menu click
                        setTimeout(function() { menu.hide(); }, 300);
                    })
                    .on('click.tagmate', function(e) {
                        tag_check();
                    })
                    .on('keydown.tagmate', function(e) {
                        if (menu.is(":visible")) {
